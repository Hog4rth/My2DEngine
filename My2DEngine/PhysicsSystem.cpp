...
void PhysicsSystem::CalculateHorizontalVelocity(const float currentDirection, const CollisionComponent& collider, VelocityComponent& velocity, const KinematicComponent& kinematic, const float deltaTime) {
